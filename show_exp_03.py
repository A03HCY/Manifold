...
def main() -> None:
    '''
    Reads the CSV results from exp_03 and plots the test accuracy.
    '''
    set_scientific_style()
    baseline_std0_path = 'data/exp_03_baseline_std0.csv'
    manifold_std0_path = 'data/exp_03_manifold_std0.csv'
    baseline_std5_path = 'data/exp_03_baseline_std5.csv'
    manifold_std5_path = 'data/exp_03_manifold_std5.csv'
    ...
    plt.tight_layout()
    plt.savefig('data/exp_03_test_acc.png')

    # Figure 2: Plot conv4_kappa and conv4_lambda_rate
    ...
    # Plot conv4_kappa
    ax1.plot(df_man_0['epoch'], df_man_0['conv4_kappa'], label='Manifold Conv (std=0.0)', linestyle='-', color=color_std0)
    ax1.plot(df_man_5['epoch'], df_man_5['conv4_kappa'], label='Manifold Conv (std=0.5)', linestyle='--', color=color_std5)
    ...
    ax2.plot(df_man_0['epoch'], df_man_0['conv4_lambda_rate'], label='Manifold Conv (std=0.0)', linestyle='-', color=color_std0)
    ax2.plot(df_man_5['epoch'], df_man_5['conv4_lambda_rate'], label='Manifold Conv (std=0.5)', linestyle='--', color=color_std5)
    ...
    plt.tight_layout()
    plt.savefig('data/exp_03_conv4_params.png')
